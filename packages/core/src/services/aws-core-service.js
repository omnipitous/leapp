...
exports.AwsCoreService = void 0;
const constants_1 = require("../models/constants");
//import { Credentials } from "@aws-sdk/client-sts";
// TODO: rename it. This naming is ambiguous.
class AwsCoreService {
    constructor(httpHandler, nativeService, logService) {
    ...
    stsOptions(session, isV3 = false, credentials = undefined) {
        let options = {};
        if (isV3 && credentials) {
            options = {
                credentials,
            ...
            options = {
                maxRetries: 0,
                httpOptions: { timeout: constants_1.constants.timeout },
            };
            if (session.region) {
                options = {
                    ...options,
...
exports.AwsCoreService = AwsCoreService;
AwsCoreService.stsEndpointsPerRegion = new Map([
